...
# New import for the Authentication and Authorization course
from flask import session as login_session
import random, string

# oAuth imports for the Authentication and Authorization course
...
def gconnect():
  ...
  # verify that the intended token is used for the intended user.
  ...
  login_session['emaild'] = data["email"]
